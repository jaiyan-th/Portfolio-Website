...
class AccessibilityAuditor:
    ...
    def audit_html_file(self, file_path):
        ...
        # Skip template files that extend other templates (they don't have complete HTML structure)
        if '{% extends' in content and file_path.name != 'base.html':
            print(f"  Skipping {file_path.name} - template extends base.html")
            return
